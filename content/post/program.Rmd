...
In the meantime, we continue in supporting the local journalists in helping to visualise their findings. We contributed to [CINS](https://www.cins.rs/)' recent article about the donations to the local political parties for the period between 2012-2018. We have created an interactive thematic map, choropleth, shading the development group of the town and adding the two more layers of information, i.e. attributes: the total amount of money donated (size and the colour of the bubble) and the amount of money received by each of the political party (popup menu).    
...
knitr::include_url("https://www.cins.rs/sns-sps-i-ds-za-sedam-godina-gradjani-strankama-donirali-oko-15-milijardi-dinara/")
```
...
url2 <- "https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-05-25.xlsx"
...
covid_sr %>% 
  ...
  annotate(geom="text", x=as.Date("2020-04-30"), y = 160, 
   ...
   annotate(geom="text", x=as.Date("2020-05-11"), y = -90, 
           label="easing of the measures", col = "dodgerblue4")
```
