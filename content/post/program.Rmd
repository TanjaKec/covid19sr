...
```{r, out.width = "100%", fig.align = 'center', fig.cap="Embedded CINS's article", echo=FALSE}
...
url2 <- "https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-06-09.xlsx"
