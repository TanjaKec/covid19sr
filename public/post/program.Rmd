...
In the meantime we continu in supporting the local journalists in helping to visualise their findings. We contributed to [CINS](https://www.cins.rs/)' recent article about the donations to the local political parties for the period between 2012-2018 by visualising their findings.
...
```{r, echo=FALSE}
#htmltools::includeHTML("images/prilozi_gradjana_links.html")
```

```{r, out.width = "100%", out.height = "100%", fig.align = 'center', echo=FALSE}
htmltools::tags$iframe(title = "My embedded document", src = "images/prilozi_gradjana_links.html")
```
