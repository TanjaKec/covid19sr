...
url2 <- "https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-07-18.xlsx"
...
Following graphs enable the comparison of the aceelleration of the spred between the ex-YU countries.
...
covid_sr %>% 
  ...
  theme(plot.title = element_text(size = 14, vjust = 2, hjust=0.5),
        ...
        panel.grid.minor.x = element_blank()) +
  geom_vline(xintercept = as.numeric(as.Date("2020-05-11")), linetype = 3, colour = "blue", alpha = 0.5) +
  geom_vline(xintercept = as.numeric(as.Date("2020-05-21")), linetype = 3, colour = "red", alpha = 0.5) +
  ...
  annotate(geom="text", x=as.Date("2020-05-11"), y = -110, 
           label="easing of the measures", col = "red") +
  annotate(geom="text", x=as.Date("2020-05-21"), y = 190, 
