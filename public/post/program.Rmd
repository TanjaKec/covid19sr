...
url2 <- "https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-04-08.xlsx"
...
The experience with COVID-19 shows that infection of disease can be controlled by implementing the measures of prevention as soon as an outbreak has been detected.
...
covid_sr %>% 
  ...
  theme(plot.title = element_text(size = 14, vjust = 2, hjust=0.5),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()) +
  geom_vline(xintercept = as.numeric(as.Date(c("2020-03-16", "2020-03-22", "2020-03-28", "2020-04-04"))), linetype=4, colour="red", alpha = 0.5) +
