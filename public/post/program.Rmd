...
Our analysis has recently been featured in [Danas](https://www.danas.rs) on their front page:

```{r embed1, out.extra='style="border: none;"', out.width='99%', fig.cap="Front page", echo = FALSE}
knitr::include_url('https://www.danas.rs/naslovna/naslovna-za-21-jul-2020/')
```

```{r embed2, out.extra='style="border: none;"', out.width='99%', fig.cap="Featered article", echo = FALSE}
...
url2 <- "https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-12-14.xlsx"
...
To monitor the effectiveness of the introduced measures we focus on daily cumulative cases of COVID-19 infection that can be expressed as 
